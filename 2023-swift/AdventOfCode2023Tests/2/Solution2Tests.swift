...
final class Solution2Tests: SolutionTests<Solution2> {
    ...
    override var exampleOutput1: String? { "8" }
    override var exampleOutput2: String? { "2286" }

    override var output1: String? { "2331" }
    override var output2: String? { "71585" }
