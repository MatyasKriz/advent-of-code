...
final class Solution1Tests: SolutionTests<Solution1> {
    ...
    override var exampleInput2: String {
        """
        two1nine
        eightwothree
        abcone2threexyz
    ...
    override var exampleOutput1: String? { "142" }
    override var exampleOutput2: String? { "281" }

    override var output1: String? { "55834" }
    override var output2: String? { "53221" }
